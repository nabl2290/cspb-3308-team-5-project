...
def seed_db():
    ...
    feeding_events = [
        ...
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 2, 8, 0),  description="Breastfed, 12 min"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 2, 12, 0), description="Formula, 4 oz"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 2, 17, 0), description=None),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 3, 8, 0),  description="Breastfed, 15 min"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 3, 12, 0), description="Formula, 5 oz"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 3, 17, 0), description=None),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 4, 8, 0),  description="Breastfed, 10 min"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6,  4, 12, 0), description="Formula, 4 oz"),
        FeedingEvent(child_id=emma.id, timestamp=datetime(2024, 6, 4, 17, 0), description=None),
